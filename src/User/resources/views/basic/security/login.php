...
<div class="user-login">
    ...
    <?= $form->field($model, 'login', ['inputOptions' => ['autofocus' => 'autofocus', 'tabindex' => '1']]) ?>

    <?= $form
        ->field($model, 'password', ['inputOptions' => ['tabindex' => '2']])
        ->passwordInput()
        ->label(
    ...
    <div class="form-group">
        <?= Html::submitButton(Yii::t('usuario', 'Sign in'), ['tabindex' => '3']) ?>
    </div>
